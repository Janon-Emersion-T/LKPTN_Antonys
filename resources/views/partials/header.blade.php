        ...
        <div class="flex items-center justify-between py-2 px-4 sm:px-6 lg:px-8 xl:px-40">
            ...
            <div class="flex items-center">
                <a href="{{ route('home') }}" class="flex items-center space-x-2">
                    <img src="{{asset('images/logo.png')}}" alt="{{ config('globals.company.name') }} Logo" class="h-12 sm:h-16 md:h-20 lg:h-24 w-auto">
                    <span class="text-lg sm:text-xl md:text-2xl font-bold text-blue-600 dark:text-blue-400 hidden sm:block">{{ config('globals.company.name') }}</span>
                </a>
            </div>
                ...
                <div class="hidden md:block">
                    <div class="flex items-center justify-center py-4">
                        ...
                        <div class="flex items-center space-x-8">
                            ...
                            <a href="{{ route('news.index') }}" class="text-sm font-semibold text-gray-900 hover:text-blue-700 dark:text-gray-900 dark:hover:text-blue-800 transition-colors duration-200 px-3 py-2 rounded-md {{ request()->routeIs('news.*') ? 'bg-blue-600 text-white hover:text-white' : '' }}">
                                News
                            </a>
                ...
                <div class="md:hidden">
                    ...
                    <div id="mobile-nav" class="hidden border-t border-gray-900/20 py-3 bg-yellow-300 dark:bg-yellow-400">
                        <div class="space-y-2">
                            ...
                            <a href="{{ route('news.index') }}" class="flex items-center px-3 py-3 text-sm font-medium text-gray-900 hover:text-blue-700 hover:bg-yellow-200 dark:text-gray-900 dark:hover:text-blue-800 dark:hover:bg-yellow-300 rounded-lg transition-colors duration-200 {{ request()->routeIs('news.*') ? 'bg-blue-600 text-white hover:text-white' : '' }}">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
