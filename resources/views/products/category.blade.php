    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8 rounded-lg bg-white p-8 shadow-sm dark:bg-gray-800">
            ...
            @if($category->description)
                <p class="mt-4 text-gray-600 dark:text-gray-400">{{ $category->description }}</p>
            @endif
            <div class="mt-4">
        ...
        @else
            ...
            <div class="rounded-lg bg-white p-12 text-center shadow-sm dark:bg-gray-800">
                ...
                <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">No products found in this category</h3>
                <p class="mt-2 text-gray-600 dark:text-gray-400">Check out other categories or browse all products.</p>
